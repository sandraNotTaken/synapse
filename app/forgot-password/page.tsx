...
import { Mail, Lock, KeyRound, Loader2, CheckCircle2, ArrowLeft, ShieldCheck } from "lucide-react";
        ...
        <div className="rounded-2xl border border-border bg-card/70 p-6 sm:p-8 shadow-2xl backdrop-blur-xl space-y-5">
          ...
          {success && (
            <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-4 text-xs font-semibold text-emerald-500 text-center space-y-1 animate-fade-in">
              ...
              <p className="text-muted-foreground text-[11px]">Redirecting to login page...</p>
            </div>
          )}
          ...
          <div className="pt-4 border-t border-border text-center text-xs text-muted-foreground">
            <Link href="/login" className="inline-flex items-center gap-1 font-bold text-indigo-600 dark:text-indigo-400 hover:underline">
